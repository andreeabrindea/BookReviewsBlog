    ...
    return (
        <div className="sidebar">
          <div className="sidebarItem">
              ...
              <img className="meImg" src ={photo} alt="me"> 
              </img>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam commodi adipisci aspernatur fugiat iusto cumque porro consectetur.</p>
          </div>
          <div className="sidebarItem">
